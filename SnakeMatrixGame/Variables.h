...
const unsigned int aboutLenght = 8;
const char* about[aboutLenght + 1] = {"Designed by", "Alina Georgescu.", "This game was", "created for the", "Introduction to", "Robotics course", "from 2022-2023.", "Thx 4 playing <3"};
